...
{
	public partial class frmGROLElectronicExam : Form
	{
		...
		private void TQholder_ChoiceEvent(clsGROLChoiceEventArgs args)
		{
		...
		private void LoadQuestion(int Qnumber)
		{
			...
			oTQ.QuestionText = oRow.Field<string>("QuestionText") + " - " + oTQ.QuestionNumber;
		...
		private void btnExit_Click(object sender, EventArgs e)
		{
			...
			{
				frmGROLTestResults oResults = new frmGROLTestResults(iCorrectAnswers, iWrongAnswers, iTotalQuestions);
				oResults.Show();
			}
			this.Close();
		}
