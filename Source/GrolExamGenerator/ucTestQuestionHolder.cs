...
namespace GrolExamGenerator
{
    public partial class ucTestQuestionHolder : UserControl
    {
        ...
        public void SetQuestion(clsQuestionInfo QuestionInfo)
        {
            ...
            if (sPreviousChoice == "")
            {
                if (QuestionInfo.IsLearnMode)
                {
                    switch (CorrectAnswerChoice)
                    {
                        case "A":
                            lblAnswerA.BackColor = Color.Yellow;
                            break;
                        case "B":
                            lblAnswerB.BackColor = Color.Yellow;
                            break;
                        case "C":
                            lblAnswerC.BackColor = Color.Yellow;
                            break;
                        case "D":
                            lblAnswerD.BackColor = Color.Yellow;
                            break;
                    }
                }
        ...
        private void SendEvent(string Choice)
        {
            ...
            if (ChoiceEvent != null)
            {
                ChoiceEvent(new clsGROLChoiceEventArgs( QuestionNumber, Choice));
            }
        }
